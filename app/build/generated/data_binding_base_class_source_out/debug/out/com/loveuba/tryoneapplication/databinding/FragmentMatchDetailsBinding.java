...
public final class FragmentMatchDetailsBinding implements ViewBinding {
  ...
  private FragmentMatchDetailsBinding(@NonNull ConstraintLayout rootView,
      @NonNull ImageView awayImg, @NonNull TextView awayName, @NonNull ImageView homeImg,
      @NonNull TextView homeName, @NonNull TextView matchDate, @NonNull Guideline matchGuidelineOne,
  ...
  public static FragmentMatchDetailsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentMatchDetailsBinding((ConstraintLayout) rootView, awayImg, awayName,
          homeImg, homeName, matchDate, matchGuidelineOne, matchGuidelineTwo, matchPlaytime,
          matchScore, matchTime, playedScores, unplayedDate);
    }
