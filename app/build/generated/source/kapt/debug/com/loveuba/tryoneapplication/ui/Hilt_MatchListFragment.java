 ...
 */
public abstract class Hilt_MatchListFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_MatchListFragment() {
    super();
  }

  Hilt_MatchListFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((MatchListFragment_GeneratedInjector) this.generatedComponent()).injectMatchListFragment(UnsafeCasts.<MatchListFragment>unsafeCast(this));
    }
  }
