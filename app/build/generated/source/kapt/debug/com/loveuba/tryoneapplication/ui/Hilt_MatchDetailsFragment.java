 ...
 */
public abstract class Hilt_MatchDetailsFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_MatchDetailsFragment() {
    super();
  }

  Hilt_MatchDetailsFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((MatchDetailsFragment_GeneratedInjector) this.generatedComponent()).injectMatchDetailsFragment(UnsafeCasts.<MatchDetailsFragment>unsafeCast(this));
    }
  }
